...
CREATE TABLE arvore(dataPlantio date NOT NULL, ultimaPoda date, localizacaoNome varchar(500) NOT NULL, latitude float NOT NULL, longitude float NOT NULL, podaSolicitada boolean NOT NULL);
